...
import sys
import os
sys.path.append('D:/GIC_Project/Tingjun/sentiment')
...
class Entropy:
    def __init__(self, ngram_cout_universe, company, window):
        ...
        self.regress_dir = "D:/GIC_Project/Tingjun/data/regress_data/bank/"
    ...
    def read_model(date,window,frequency):
        ...
        pickle_in = open("D:\\GIC_Project\\Tingjun\\data\\2_models\\bank\\"   + pik_name + '.pickle', "rb")
...
def run():
    ...
    grams3_dir = "D:/GIC_Project/Tingjun/data/3grams/bank/"
