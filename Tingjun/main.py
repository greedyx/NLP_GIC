import sys
sys.path.append('E:\GIC_Project\Tingjun')
import pickle
import pandas as pd
import os
...
company = 'Amazon'  # 目标公司
cleaned_dir = "E:/GIC_Project/Tingjun/data/cleaned/"  # data clean之后的输出file所在文件夹，会在下面自动创建
...
def data_clean1(company,frequency:str = 'M'):
    ...
    series = pd.read_csv(r"E:\GIC_Project\Tingjun\data\{}.csv".format(company))  # 1.你自己的某个公司的csv文件所在位置
...
grams3_dir = "E:/GIC_Project/Tingjun/data/3grams/"  # 3grams data输出文件所在文件夹
...
model2_dir = 'E:/GIC_Project/Tingjun/data/2_models'
